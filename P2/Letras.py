...
class Example(Base):
    ...
    def initialize(self):
        ...
        position_data_triangle = [[-0.6,  0.0,  0.0], #A#
                                  [-0.6,  0.15,  0.0], #B#
                                  [-0.7,  0.0,  0.0], #C#
        ...
        # Set up vertex array object - triangle #
        self.vao_triangleS = GL.glGenVertexArrays(1)
        GL.glBindVertexArray(self.vao_triangleS)
        position_data_triangleS = [[0.05,  0.168,  0.0], #A#
                                  [0.0,  0.168,  0.0], #B#
                                  [0.049,  0.191,  0.0], #C#
...
#ERRO#
        ...
        self.vertex_count_triangleS = len(position_data_triangleS)
        position_attribute_triangleS = Attribute('vec3', position_data_triangleS)
        position_attribute_triangleS.associate_variable(self.program_ref, 'position')
    ...
    def update(self):
        ...
        # Draw the triangle
        GL.glBindVertexArray(self.vao_triangle)
        GL.glDrawArrays(GL.GL_TRIANGLE_STRIP, 0, self.vertex_count_triangle)

        # Draw the triangle
        GL.glBindVertexArray(self.vao_triangleC)
        GL.glDrawArrays(GL.GL_TRIANGLE_STRIP, 0, self.vertex_count_triangleC)

        # Draw the triangle
        GL.glBindVertexArray(self.vao_triangleS)
        GL.glDrawArrays(GL.GL_TRIANGLE_STRIP, 0, self.vertex_count_triangleS)
