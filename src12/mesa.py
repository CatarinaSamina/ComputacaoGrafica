...
class Mesa(Object3D):
    def __init__(self):
        ...
        material = PhongMaterial(property_dict={"baseColor": [1, 1, 1]})
        material2 = PhongMaterial(property_dict={"baseColor": [0.15, 0.25, 0.5]})
        texture = Texture(file_name="images/mesa.png")
