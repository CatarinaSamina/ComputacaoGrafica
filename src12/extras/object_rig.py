...
class ObjectRig(Object3D):
    ...
    def __init__(self, units_per_second=1, degrees_per_second=60):
        ...
        # Defaults: U, J, H, k, O, L (move), Y, I (turn), P, Ç (look)
