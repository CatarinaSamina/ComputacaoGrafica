...
class Racket(Object3D):
    def __init__(self):
        ...
        self.material1 = PhongMaterial(texture=self.raquete_texture)
        #self.material1 = TextureMaterial(texture=self.raquete_texture, property_dict={"repeatUV": [100, 100]})
        self.black = PhongMaterial(property_dict={"baseColor": [.09, 0.09, 0.09]})
        self.brown = PhongMaterial(property_dict={"baseColor": [.8, 0.7, 0.5]})
