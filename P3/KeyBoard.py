...
##
    ...
    def update(self):
        ...
        if (self.input.isKeyPressed("up") > 0 and 1.0 > self.translationC.data[1] >1.0):
            self.translationC.data[1] += self.dy
        if (self.input.isKeyPressed("right") > 0 and 0.2> self.translationC.data[0]>1.0):
            self.translationC.data[0] += self.dx
        if (self.input.isKeyPressed("down") > 0 and self.translationC.data[1] > -1.0):
            self.translationC.data[1] -= self.dy
        if (self.input.isKeyPressed("left") > 0 and self.translationC.data[0] > -1.0):
            self.translationC.data[0] -= self.dx
